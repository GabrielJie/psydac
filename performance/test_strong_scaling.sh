...
srun -N 4 -n 64 python3 -c 'from test_perf_2d_parallel import test_perf_poisson_2d_1;test_perf_poisson_2d_1()'
srun -N 4 -n 128 python3 -c 'from test_perf_2d_parallel import test_perf_poisson_2d_1;test_perf_poisson_2d_1()'
