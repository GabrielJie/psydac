...
srun -n 64 python3 -c 'from test_perf_2d_parallel import test_perf_poisson_2d_3;test_perf_poisson_2d_3()'
srun -n 128 python3 -c 'from test_perf_2d_parallel import test_perf_poisson_2d_3;test_perf_poisson_2d_3()'
